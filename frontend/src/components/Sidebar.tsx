...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 h-full flex flex-col shadow-sm select-none">
      ...
      {/* Bottom Profile and Settings (Placed at the bottom, not in the list) */}
